...
const product_routes = [
    {
        ...
        path: "/get-products",
        options: {
            description: "Get all products according to car brand, product name, category.",
            validate: {
...

    {
        ...
        options: {
            description: "Get all products according to car brand, product name, category for customers.",
            validate: {
                query: productValidators.fetch_all_product
            },
            tags,
